...
const ::uint32_t TableStruct_greet_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_greet_2eproto(&descriptor_table_greet_2eproto);
namespace greet {
// ===================================================================
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "greet.HelloRequest.name"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* HelloRequest::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "greet.HelloRequest.name");
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "greet.HelloReply.message"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* HelloReply::_InternalSerialize(
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "greet.HelloReply.message");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
...
template<> PROTOBUF_NOINLINE ::greet::HelloRequest*
Arena::CreateMaybeMessage< ::greet::HelloRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::greet::HelloRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::greet::HelloReply*
Arena::CreateMaybeMessage< ::greet::HelloReply >(Arena* arena) {
