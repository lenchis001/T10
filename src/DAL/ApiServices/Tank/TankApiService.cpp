...
namespace T10::DAL::ApiServices::Tanks
{
    ...
    boost::shared_ptr<DataActionResult<std::vector<Tank>>> TankApiService::getAll()
    {
        ...
        return boost::make_shared<DataActionResult<std::vector<Tank>>>(ptreeResult.getError(), tanks);
    }
}