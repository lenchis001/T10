...
public:
	...
	virtual void addTriangleSelector(boost::shared_ptr<ITriangleSelector> toAdd) = 0;
	...
	virtual bool removeTriangleSelector(boost::shared_ptr<ITriangleSelector> toRemove) = 0;
